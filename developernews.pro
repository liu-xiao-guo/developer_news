...
UBUNTU_TRANSLATION_DOMAIN="developernews.liu-xiao-guo"
...
aptest.commands = bash $$PWD/developernews/tests/autopilot/run
aptest.depends  = sub-developernews

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/developernews/tests/unit 
unittest.depends  = sub-developernews
